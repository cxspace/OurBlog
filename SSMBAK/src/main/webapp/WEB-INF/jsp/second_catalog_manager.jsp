...
<div id="content" class="pmd-content inner-page">
	<div class="container-fluid full-width-container value-added-detail-page">
			...
			<table class="table table-mc-red pmd-table">
				...
				<tr>
					...
					<td class="pmd-table-row-action">
						...
						<a href="${pageContext.request.contextPath}/second_catalog/editUI?id=${items.id}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
							<i class="material-icons md-dark pmd-sm">edit</i>
						</a>

						<a href="${pageContext.request.contextPath}/blog/article_manager?id=${items.id}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
							<i class="material-icons md-dark pmd-sm">keyboard_arrow_right</i>
						</a>

						<a href="${pageContext.request.contextPath}/second_catalog/delete?id=${items.id}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
		...
		<form action="${pageContext.request.contextPath}/second_catalog/add" method="post">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header bordered">
						...
						<h2 class="pmd-card-title-text">添加二级目录</h2>
					</div>
					<div class="modal-body">
							<div class="form-group pmd-textfield pmd-textfield-floating-label">
								<label for="firstClassName">二级目录名</label>
								<input type="text" name="name" class="mat-input form-control" id="firstClassName" value="">
								<span class="help-text">必须输入!</span> </div>
