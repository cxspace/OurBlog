	...
	<div class="container-fluid full-width-container value-added-detail-page">
		<div>
			...
			<ol class="breadcrumb text-left">
				<li><a href="${pageContext.request.contextPath}/main/index">博客管理</a></li>
		...
		<form method="post" action="${pageContext.request.contextPath}/first_catalog/edit">
			<div class="pmd-card-body">
				...
				<div class="form-group pmd-textfield pmd-textfield-floating-label">
					...
					<div class="input-group">
						...
						<input type="text" name="name" value="${firstCatalog.name}" class="form-control" id="Account">
					</div>
				</div>

				<input type="hidden" name="id" value="${firstCatalog.id}">
