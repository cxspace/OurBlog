...
<div id="content" class="pmd-content inner-page">
	...
	<div class="container-fluid full-width-container blank">
		...
		<ol class="breadcrumb text-left">
		  ...
		  <li class="active">类别选择</li>
		</ol><!--breadcrum end-->
	
		<div class="no-table-blank-state row">


			<c:forEach items="${secondCatalogs}" var="items" varStatus="st">

			<div class="col-lg-4 col-md-4 col-xs-6">
				<!--pmd-z-depth-->
				<div class="pmd-card pmd-z-depth-3 shadow-demo">
					<div class="pmd-card-body">
						<a href="${pageContext.request.contextPath}/blog/blog_select?id=${items.id}" class="btn pmd-ripple-effect btn-primary">${items.name}</a >
					</div>
				</div>
