...
<div id="content" class="pmd-content inner-page">
	<div class="container-fluid full-width-container value-added-detail-page">
		...
		<form method="post" action="${pageContext.request.contextPath}/second_catalog/edit">
			<div class="pmd-card-body">

				<div class="form-group pmd-textfield pmd-textfield-floating-label">
					<label for="Account" class="control-label pmd-input-group-label">目录名</label>
					<div class="input-group">
						<div class="input-group-addon"><i class="material-icons md-dark pmd-sm">edit</i></div>
						<input type="text" name="name" value="${secondCatalog.name}" class="form-control" id="Account">
					</div>
				</div>

				<input type="hidden" name="id" value="${secondCatalog.id}">

				<input type="hidden" name="first_catalog_id" value="${secondCatalog.first_catalog_id}">
