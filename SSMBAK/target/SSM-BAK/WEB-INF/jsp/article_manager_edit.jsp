	...
	<div class="container-fluid full-width-container blank">
		...
		<div class="no-table-blank-state row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<form id="validationForm" action="${pageContext.request.contextPath}/blog/article_manager_edit" method="post">
								...
								<div class="group-fields clearfix row">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
										<div class="form-group pmd-textfield pmd-textfield-floating-label">
											...
											<input type="text" id="title" value="${document.title}" name="title" class="form-control">
										</div>
									</div>
								</div>


								<textarea id="summernote" name="content" class="form-control" rows="3" placeholder="请输入正文">${document.content}</textarea>
