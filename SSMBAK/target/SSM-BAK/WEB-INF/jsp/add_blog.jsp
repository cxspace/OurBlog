	...
	<div class="container-fluid full-width-container blank">
		...
		<div class="no-table-blank-state row">
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					...
					<form id="validationForm" action="${pageContext.request.contextPath}/blog/add" method="post">
						<div class="pmd-card pmd-z-depth">
							<div class="pmd-card-body">
								...
								<div class="group-fields clearfix row">
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group pmd-textfield pmd-textfield-floating-label">
											<label>一级目录 *</label>
											<select name="first_catalog_id" onchange="javascript:catalogChange()" id="first_catalog_id" class="select-simple form-control pmd-select2">
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group pmd-textfield pmd-textfield-floating-label">
											<label>二级目录 *</label>
											<select name="second_catalog_id" id="second_catalog_id" class="select-simple form-control pmd-select2">

												<c:forEach items="${secondCatalog}" var="items">
													<option value="${secondCatalog.id}">${secondCatalog.name}</option>
												</c:forEach>
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
										<div class="form-group pmd-textfield pmd-textfield-floating-label">
											...
											<input type="text" name="useremail" id="regular2" class="form-control">
										</div>
									</div>
								</div>
							...
							<div class="pmd-card-actions">
								<button type="submit" class="btn btn-primary next">提交</button>
							</div>
...
<script>
    ...
    function catalogChange() {
        ...
        var first_catalog_id = $('#first_catalog_id').val();

        var html = "<option>--请选择--</option>";

        var CommitUrl = "${pageContext.request.contextPath}/blog/secondCatalog?id="+first_catalog_id;
        ...
        $.ajax(
            {
                ...
                success: function (result) {
                    ...
                    if (Curedata.secondCatalogs != null) {

                        for (var i = 0; i < Curedata.secondCatalogs.length; i++) {

                            html += "<option value='" + Curedata.secondCatalogs[i].id + "'>" + Curedata.secondCatalogs[i].name + "</option>";
                        }
                        $("#second_catalog_id").empty();
                        $(html).appendTo("#second_catalog_id");
                    }
                }
            }
        )
