...
<aside class="pmd-sidebar sidebar-default pmd-sidebar-slide-push pmd-sidebar-left pmd-sidebar-open bg-fill-darkblue sidebar-with-icons" role="navigation">
	<ul class="nav pmd-sidebar-nav">
		...
		<li>
			<a class="pmd-ripple-effect" href="${pageContext.request.contextPath}/">
	...
	<div class="container-fluid full-width-container value-added-detail-page">
		<div>
			<div class="pull-right table-title-top-action">
				...
				<a data-target="#form-dialog-add" data-toggle="modal" class="btn btn-primary pmd-btn-raised add-btn pmd-ripple-effect pull-left">
					添加
				</a>
		...
		<div class="table-responsive pmd-card pmd-z-depth">
			<table class="table table-mc-red pmd-table">
				...
				<tr>
					<td data-title="Ticket No">${items.id}</td>
					<td data-title="date">${items.name}</td>
					<td class="pmd-table-row-action">
						<a href="${pageContext.request.contextPath}/first_catalog/editUI?id=${items.id}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
							<i class="material-icons md-dark pmd-sm">edit</i>
						</a>

						<a href="${pageContext.request.contextPath}/first_catalog/second_catalog_manager?id=${items.id}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
							<i class="material-icons md-dark pmd-sm">keyboard_arrow_right</i>
						</a>

						<a href="${pageContext.request.contextPath}/first_catalog/delete?id=${items.id}" class="btn pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-default btn-sm">
		...
		<form method="post" action = "${pageContext.request.contextPath}/first_catalog/add">

		<div tabindex="-1" class="modal fade" id="form-dialog-add" style="display: none;" aria-hidden="true">

			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header bordered">
						<button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
						<h2 class="pmd-card-title-text">添加一级目录</h2>
					</div>

					<div class="modal-body">

						<div class="form-group pmd-textfield pmd-textfield-floating-label">
								<label for="firstClassName">一级目录名</label>
								<input type="text" name="name" class="mat-input form-control" id="firstClassName" >
								<span class="help-text">必须输入!</span>
						</div>


					</div>
					<div class="pmd-modal-action">
						<button   class="btn pmd-ripple-effect btn-primary" type="submit">保存 </button>
						<button   class="btn pmd-ripple-effect btn-default" type="button">关闭</button>
					</div>
				</div>
			</div>
